...
<head>
    ...
    <link rel="stylesheet" href="{{ bagisto_asset('css/nice-select.css') }}">
    ...
    <link rel="stylesheet" href="{{ bagisto_asset('css/themify-icons.css') }}">
    <link rel="stylesheet" href="{{ bagisto_asset('fonts/icomoon/style.css') }}">
